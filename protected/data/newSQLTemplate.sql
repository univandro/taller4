...
--
-- Servidor: localhost
-- Tiempo de generación: 26-05-2012 a las 21:38:18
...
--
CREATE DATABASE `medico_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `medico_db`;
...
--
-- Creación: 18-05-2012 a las 04:54:21
--
...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  `google_map` varchar(145) NOT NULL,
...
INSERT INTO `person` (`id_person`, `name`, `father_name`, `mother_name`, `age`, `birth_date`) VALUES
(1, 'admin', 'admin', 'admin', 25, '1987-05-01');
