...
<div class="container" id="page">
	<div id="topnav">
		<div class="topnav_text">
                    ...
                    <a href='<?php if(!Yii::app()->user->isGuest)
                                        echo Yii::app()->homeUrl.'?r=site/logout'; ?>'>
                             <?php if(!Yii::app()->user->isGuest)
                                        echo 'My Account'; ?>
                    </a><?php if(!Yii::app()->user->isGuest) echo ' | '; ?>
                                    
                    <a href='#'>Settings</a> | 
                    <a href='<?php if(!Yii::app()->user->isGuest)
                                        echo Yii::app()->homeUrl.'?r=site/logout'; 
                                    else
                                        echo Yii::app()->homeUrl.'?r=site/login'; ?>'>
                             <?php if(!Yii::app()->user->isGuest)
	...
	<div id="header">
		<div align="center" id="logo"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo_uni"></img><?php //echo CHtml::encode(Yii::app()->name); ?></div>
	</div><!-- header -->
    <!--
